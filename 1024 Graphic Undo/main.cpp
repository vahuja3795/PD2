// USING PROFESSOR REED'S SOLUTION
//  prog5_1024.cpp
...
void displayBoard(sf::RenderWindow &window,sf::Font font,int* board,Square* squaresArray,sf::Text &messagesLabel,
    ...
    for( int i=0; i<squaresPerSide*squaresPerSide; i++) {
		...
		if (i >= 0 && i <= 3) {
           ...
           squaresArray[ i] = Square(50, 50 * count + count * 10, 70, sf::Color::White, true, name);
        } else if (i >= 8 && i <= 11) {
            if(i == 8) {
             count = 0;
           } else if(i == 9) {
           ...
           squaresArray[ i] = Square(50, 50 * count + count * 10, 140, sf::Color::White, true, name);
        } else if (i >= 12 && i <= 15) {
            if(i == 12) {
             count = 0;
           } else if(i == 13) {
          ...
          squaresArray[ i] = Square(50, 50 * count + count * 10, 210, sf::Color::White, true, name);
        }
		...
		squaresArray[i].displayText( &window, font, sf::Color::Black, 30);
	}
